        ...
        {packs.data && packs.data.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {packs.data.map((pack) => (
              <Card
                key={pack.id}
                className="overflow-hidden bg-slate-900 border-slate-800 hover:border-amber-500/50 hover:shadow-lg hover:shadow-amber-900/10 transition-all duration-300 group flex flex-col"
              >
                {/* Imagen del Sobre */}
                ...
                <CardHeader className="p-4 pb-2 flex-1">
                  <CardTitle
                    className="text-base font-bold text-slate-100 line-clamp-2"
                    title={pack.name}
                  >
                    {pack.name}
                  </CardTitle>
                ...
                <CardFooter className="p-4 pt-0 flex justify-between items-center mt-auto">
                  ...
                  <Button
                    size="sm"
                    className="bg-indigo-600 hover:bg-indigo-500 text-white shadow-lg shadow-indigo-900/20 border border-indigo-500/50"
                  >
