...
export default function MagicForum() {
  ...
  return (
    <>
      ...
      <div style={{ display:"grid",gridTemplateColumns:"224px 1fr 272px",height:"100%",
        ...
        <aside style={{ background:C.surface,borderRight:`1px solid ${C.border}`,
          ...
          <div style={{ padding:"18px 18px 16px",display:"flex",alignItems:"center",gap:10,
            ...
            <div style={{ width:34,height:34,background:C.accent,borderRadius:8,
                          ...
                          fontSize:17,fontWeight:700,color:"#fff",flexShrink:0,fontFamily:FONT }}>M</div>
          ...
          {[
            ...
            <div key={section}>
              <div style={{ padding:"10px 18px 4px",fontSize:10,fontWeight:700,color:C.textMuted,
                            textTransform:"uppercase",letterSpacing:"1px",fontFamily:FONT }}>{section}</div>
              {items.map((it: any) => (
          ...
          {view === "feed" && (
            <>
              <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:16 }}>
                ...
                <button onClick={() => setView("create")} style={{ background:C.accent,color:"#fff",border:"none",
              ...
              <div style={{ display:"flex",gap:4,marginBottom:14,background:C.surface,
            ...
            <div style={{ background:C.surface,border:`1px solid ${C.border}`,borderRadius:8,overflow:"hidden" }}>
              <div style={{ padding:"12px 16px",borderBottom:`1px solid ${C.border}`,
                ...
                <div style={{ fontSize:15,fontWeight:600,color:C.textPrimary,
                              fontFamily:FONT,flex:1,marginRight:12 }}>{activePost.title}</div>
                <button onClick={() => setView("feed")}
                  style={{ fontSize:12,color:C.textSecondary,cursor:"pointer",padding:"4px 10px",
              ...
              <div style={{ padding:"12px 16px",borderBottom:`1px solid ${C.border}` }}>
                <textarea
                  ...
                  rows={3}
                  style={{ width:"100%",background:C.surface2,border:`1px solid ${C.border}`,borderRadius:6,
                ...
                <div style={{ display:"flex",justifyContent:"flex-end" }}>
                  <button onClick={handleCreateComment} disabled={isSubmittingComment || !newCommentBody.trim()}
                    style={{ background:C.accent,color:"#fff",border:"none",padding:"6px 14px",borderRadius:6,
              ...
              <div style={{ display:"flex",flexDirection:"column",gap:16 }}>
                ...
                <div style={{ display:"flex",justifyContent:"flex-end",marginTop:8 }}>
                  <button onClick={handleCreatePost} disabled={isSubmitting}
                    style={{ background:C.accent,color:"#fff",border:"none",padding:"10px 24px",borderRadius:6,fontSize:14,
        ...
        <aside style={{ padding:16,display:"flex",flexDirection:"column",gap:12 }}>
            ...
            <div style={{ padding:"6px 14px" }}>
              {tournaments.map((t,i) => (
                <div key={i} style={{ display:"flex",alignItems:"center",gap:8,padding:"7px 0",
                  ...
                  <span style={{ fontSize:12,color:C.textSecondary,flex:1,fontFamily:FONT }}>{t.name}</span>
              ...
              {([["Online ahora","342",true],["Miembros","8.431",false],["Posts hoy","47",false]] as [string,string,boolean][])
                ...
                <div key={i} style={{ display:"flex",justifyContent:"space-between",alignItems:"center",
                  ...
                  <span style={{ fontSize:12,color:C.textSecondary,fontFamily:FONT }}>
                    {dot && <span style={{ display:"inline-block",width:8,height:8,borderRadius:"50%",
          ...
          <Widget title="Reglas del foro">
            <div style={{ padding:"4px 14px" }}>
              {RULES.map((rule,i) => (
                <div key={i} style={{ fontSize:12,color:C.textSecondary,padding:"6px 0",
