...
export interface Reply {
  ...
  timeAgo: string; score: number; body: string; avatar_url?: string; hidden?: boolean;
  reputation?: number;
  can_delete?: boolean;
  can_edit?: boolean;
  replies?: Reply[];
...
export interface Comment {
  id: number; author: string; author_id: number; avatarColor: string; initials: string;
  timeAgo: string; score: number; body: string; avatar_url?: string; replies: Reply[]; is_hidden?: boolean;
  reputation?: number;
  can_delete?: boolean;
  can_edit?: boolean;
}
